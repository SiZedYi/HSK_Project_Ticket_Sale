...
public class Phim_Dao extends Dao<Phim>{
	...
	public boolean create(Phim phim) {
		...
		" Phim values(?,?,?,?,?,?,?)");
			...
			statement.setString(7, phim.getHinhAnh());
	...
	public boolean update(Phim phim) {
	    ...
	    try {
	        ...
	        statement.setString(6, phim.getHinhAnh());
	...
	@Override
	public void insertingStatement(PreparedStatement stmt, Phim t, Connection con) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void updatingStatement(PreparedStatement stmt, Phim t, Connection con) {
		// TODO Auto-generated method stub
