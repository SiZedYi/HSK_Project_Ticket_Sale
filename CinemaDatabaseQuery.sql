...
INSERT INTO NhanVien (maNV, tenNV, gioiTinh, ngaySinh, cccd, noiCuTru, sdt, trinhDo, email, ngayTuyenDung, luong, quanLy) VALUES
('NV001', N'Nguyen Van A', N'Nam', '1990-01-01', '123456789', 'Hanoi', '123456789', 'Bachelor', 'nvA@example.com', '2020-01-01', 5000000, NULL),
('NV002', N'Tran Thi B', N'Nữ','1995-05-05', '987654321', 'Hanoi', '987654321', 'Bachelor', 'nvB@example.com', '2020-01-01', 4500000, 'NV001'),
('NV003', N'Le Van C', N'Nam','1998-10-10', '456123789', 'Hanoi', '456123789', 'Bachelor', 'nvC@example.com', '2020-01-01', 4000000, 'NV001');
...
('TK001', 'user1', 'password1', 'NV001', 'Nhân viên'),
('TK002', 'user2', 'password2', 'NV002', 'Quản lý'),
('TK003', 'user3', 'password3', 'NV003', 'Nhân viên');
